...
isLoggedIn=false
}, colors=ButtonDefaults.buttonColors(Color.Red)){Text("LOGOUT")}
}
}
} else {
...
Text("Tinggal: HP + Email + Password = 15 detik!", fontSize=10.sp, color=Green, fontWeight=FontWeight.Bold, modifier=Modifier.fillMaxWidth())
}
}
){ padding ->
...
Text("✅ FIX: Tombol sekarang di bawah (bottomBar) jadi gak ketutup keyboard! Kursor otomatis turun pakai Next.", fontSize=9.sp, color=Color(0xFF4CAF50))
